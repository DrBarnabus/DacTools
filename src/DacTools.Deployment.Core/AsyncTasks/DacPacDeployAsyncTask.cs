...
public class DacPacDeployAsyncTask : AsyncTaskBase
{
    ...
    public override Task Run(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            dacServices.ProgressChanged += (_, args) => LogDebug("DacServices Progress",
                "OperationId {0}, Status {1}, Message {2}", args.OperationId, args.Status, args.Message);
        ...
        LogInfo("Internal", "DacPac Deployment AsyncTask completed successfully in {0}ms.",
